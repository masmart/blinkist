...
from controllers.AdminController import dashboard_view, books_view, book_add_view, book_edit_view, category_view, author_view, report_view, idea_add_view, idea_edit_view, audio_add_view, audio_edit_view
